...
uint8_t mcp2515_read(uint8_t address);                      // Read register
void mcp2515_write(uint8_t address, uint8_t data);         // Write register
void mcp2515_request_to_send(uint8_t buffer_select);       // Request to send (RTS)
uint8_t mcp2515_read_status(void);                         // Read status
void mcp2515_bit_modify(uint8_t address, uint8_t mask, uint8_t data); // Bit modify

// Higher level functions
void mcp2515_set_mode(uint8_t mode);                       // Set operating mode
void mcp2515_init_loopback(void);                          // Initialize for loopback mode
void mcp2515_init_normal(void);                            // Initialize for normal mode (real CAN bus)
